...
\end{center}
The attraction effect is one of the most well-known decision biases, which has played a key role in the development of many popular choice models over the past decades. However, the real-world relevance of the attraction effect has recently been challenged, as results from a series of experiments by \citeA{Frederick2014} and \citeA{Yang2014} have suggested that this decision bias is only confined to scenarios where options are represented in an attribute by alternative format, and is absent in choice contexts where options have naturalistic representations. Since the overwhelming majority of real-world consumer choices involve options with naturalistic attributes, these results severely undermine the theoretical and empirical importance of the attraction effect in decision research. However, \citeA{Huber2014} have criticised the experiments of \citeauthor{Frederick2014} and \citeauthor{Yang2014} on methodological grounds, arguing that their experiments did not meet the set of criteria required for a strict test of the attraction effect. Guided by these criteria, this paper describes the first rigorous investigation of the attraction effect in choices involving complex objects. While our results are similar to that of \citeauthor{Frederick2014} and \citeauthor{Yang2014} in that we found no evidence for the attraction effect, our strict methodological approach constitutes a much stronger basis for claiming that the attraction effect does not extend to choices between naturalistic options.
\thispagestyle{empty}
...
\section*{\sectionformat The attraction effect}
...
These two studies sparked considerable interest amongst decision making researchers, and led to the re-examination of the boundary conditions of the attraction effect. \citeA{Huber2014} discussed five critical features that can inhibit the attraction effect, and argued that at least one of these five features is present in each of the 38 experiments reported by \citeA{Frederick2014}. The five critical features to be avoided are: (1) strong prior preferences over the target and competitor, (2) inability to identify the dominance relationship  between the target and the decoy, (3) heterogeneity in prior preferences over the target and competitor, (4) an undesirable decoy and (5) a decoy that is too desirable. \citeA{Simonson2014a} further stressed the importance of the detection of the dominance relationship in observing the attraction effect, and also pointed out several other smaller, specific methodological shortcomings of the studies by \citeauthor{Frederick2014} and \citeauthor{Yang2014}. In essence, \citeauthor{Huber2014} and \citeauthor{Simonson2014a} have argued that because each of the naturalistic-option experiments had at least one of these critical features, the failure to find an attraction effect in these experiments is not a sound base for concluding that the attraction effect does not generalise to real-world consumer choices.
...
\section*{\sectionformat Testing the attraction effect with real-world stimuli}
...
\section*{\sectionformat Discussion}
