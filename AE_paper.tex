...
\AT{Done, the only plot I don't have in pdf is the choice task screenshot. I've tried to take a new screenshot from $http://www.stewart.warwick.ac.uk/expt/big_three_movies_2/$ but I can't access it anymore.}
...
\AT{Updated with the new scaling, CI around intercept is 0.8 and 1.2 now; the same CI from an intercept-only regression is 0.9 and 1.1; glmer still gives exact same results as glm}
...
\begin{table*}[htb] \centering
  \begin{threeparttable}
    \captionsetup{justification=centering}
    \caption{Odds-ratios and 95\% CIs from a mixed-effects logistic model with subject-specific intercepts.}
