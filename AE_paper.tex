...
>>>>>>> b9e0d7fccd6210e4a29d3f8c0c28ba22be3b0dd4
...
Contrary to \citeauthor{Frederick2014}, we do not think that this null result undermines the importance of the attraction effect in decision making research. There are still a wide variety of strong and robust findings where the attraction effect significantly biases choices. However, our results show that there are boundaries on this effect. There are decision making scenarios where the attraction effect is not present, and these naturalistic, non-numerical stimuli are such an example.
