...
\AT{Intercept-only regression added, is that ok though? It wasn't in the preregistation}
...
These exclusion criteria were validated in a pilot study, where we collected ratings for a set of books, and included repeat trials. The participants filtered out by these three criteria were the ones who gave the least consistent ratings to repeated stimuli (correlation $r < 0.8$).
