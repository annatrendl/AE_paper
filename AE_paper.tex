...
\centering
\captionsetup{justification=centering}
		\caption{The proportion of trials where the target was chosen instead of the competitor. Each dot is a participant. Dots are jitter slightly. The red dot and error bars show the bootstrapped mean and 95\% CI \NS{"Mean of all" -> "Mean Over Participants". Say what the point size means}}
...
%\TM{Why are there different numbers of observations in the two models}


%\AT{Because of the "don't know" similarity ratings}
