...
\centering
\captionsetup{justification=centering}
\caption{The distribution of the average similarity rating for each target-decoy candidate pair (N = 1242). \NS{Adjust x-axis to go from 1--7, and add labels 1,2,3,4,5,6,7. APA is title caps for labels and axes "Mean Similarity Rating". The dotted line is the criteria for accepting a pair as similar. Make binwidth not 1/6---which is weird, but, say, 0.2.}
