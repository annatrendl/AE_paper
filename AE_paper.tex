...
\AT{All variables in this regression have been scaled by each subject. The CI on the intercept was so big because previously I have only scaled the similarity ratings and not the rating difference.}
...
\\[-1.8ex] & Target chosen \\ 
\hline \\[-1.8ex] 
 Seen all & 1.020 (0.648, 1.606) \\ 
  TC similarity rating & 0.961 (0.863, 1.070) \\ 
  TD similarity rating & 0.935 (0.841, 1.040) \\ 
  TD rating difference & 0.894$^{**}$ (0.803, 0.994) \\ 
  Intercept & 0.989 (0.636, 1.538) \\ 
 \hline \\[-1.8ex] 
Observations & 1,441 \\ 
Log Likelihood & $-$995.776 \\ 
Akaike Inf. Crit. & 2,003.552 \\ 
Bayesian Inf. Crit. & 2,035.190 \\ 
\hline 
\hline \\[-1.8ex] 
