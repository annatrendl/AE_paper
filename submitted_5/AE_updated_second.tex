...
\\[-1.8ex] & \multicolumn{2}{c}{Target chosen} \\ 
 & Model 1 & Model 2 \\ 
\hline \\[-1.8ex] 
 Intercept & 0.868 (0.652, 1.148) & 1.032 (0.710, 1.497) \\  
  Seen all & 0.922 (0.816, 1.041) & 0.923 (0.816, 1.044) \\ 
  TC similarity rating & 0.890 (0.782, 1.009) & 0.895 (0.787, 1.016) \\ 
  TD similarity rating & 0.892 (0.791, 1.005) & 0.855$^{*}$ (0.749, 0.976) \\ 
  TD rating difference &  & 1.115 (0.970, 1.284) \\ 
  TC rating &  & 1.067 (0.704, 1.620) \\ 
  order:CTD &  & 0.662$^{*}$ (0.437, 0.998) \\ 
  order:DCT &  & 0.827 (0.543, 1.257) \\ 
  order:TCD &  & 0.825 (0.541, 1.255) \\ 
  order:TDC &  & 0.824 (0.538, 1.260) \\ 
  number of choices &  & 1.025 (0.873, 1.203) \\ 
  trial number &  & 0.981 (0.836, 1.151) \\ 
  \hline \\[-1.8ex] 
Observations & 1,014 & 1,014 \\ 
Log Likelihood & $-$697.223 & $-$693.110 \\ 
Akaike Inf. Crit. & 1,406.446 & 1,414.220 \\ 
Bayesian Inf. Crit. & 1,435.976 & 1,483.123 \\ 
\hline 
\hline \\[-1.8ex] 
%\textit{Note:}  & \multicolumn{2}{r}{$^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01} \\ 
\end{tabular}
    \begin{tablenotes}
      \small
      \item Notes: $^{*}$p$<$0.05; all variables have been scaled apart from Seen all and order variables; Seen all is coded 0.5 (Yes) and -0.5 (No); benchmark for order variables is CDT; T - Target, C - Competitor, D - Decoy
    \end{tablenotes}
  \end{threeparttable}
\end{table*}
